...
class ChildController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PassportTreeviewBundle:Child')->findAll();
     ...
     * @Method("POST")
     * @Template("PassportTreeviewBundle:Child:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PassportTreeviewBundle:Child')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PassportTreeviewBundle:Child:edit.html.twig")
     */
